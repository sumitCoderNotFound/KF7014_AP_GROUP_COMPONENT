...
@EnableJpaRepositories(basePackages = "com.waterservices.monitoring.repository")
@EntityScan(basePackages = "com.waterservices.monitoring.model")
class MonitoringRepositoryTest {

    @Autowired
    private TestEntityManager entityManager;

    // TODO: IntelliJ thinks we can't autowire MonitoringRepository
    //  Reality check: everything works fine when running tests.
    //  Adding @EnableJpaRepositories and @EntityScan helped,
    //  but the error still lingers. IDE paranoia?
    @Autowired
